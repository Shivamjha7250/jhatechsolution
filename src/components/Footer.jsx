import { Mail, Instagram, Phone,Linkedin, MapPin } from "lucide-react";
import { useState } from "react";
import API_URL from "../config";
import GoogleBusinessIcon from "../assets/google-business.svg";
const Footer = () => {
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-400 text-sm">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:back2campus@gmail.com" className="hover:text-white transition">
             ...
             <li className="flex items-center gap-3">
            <img src={GoogleBusinessIcon} alt="Google Business" className="w-5 h-5" />
              <a
            href="https://share.google/heycobZklIaDuIhX3"
           target="_blank"
           rel="noopener noreferrer"
            className="hover:text-white transition"
             >
